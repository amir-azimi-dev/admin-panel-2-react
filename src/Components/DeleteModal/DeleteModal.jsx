...
export default function DeleteModal({confirmDeletion, cancelDeletion, activeItem}) {
  return createPortal(
    <div className="modal-parent visible">
      <div className="delete-modal modal">
        ...
        <hr />
        <p className='delete-modal__name'>نام محصول: {activeItem.title}</p>
        ...
        <div className="delete-modal__buttons">
          ...
          <button className='delete-modal__btn delete-modal-btn__accept' onClick={() => confirmDeletion(activeItem.id)}>حذف</button>
        </div>
      </div>
    </div>
    , document.body)
